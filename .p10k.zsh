# Generated by Powerlevel10k configuration wizard on 2025-06-01 at 16:39 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=15  # blanc (couleur 15 = bright white dans la palette 256)
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=27    # noir (ou ce que tu veux)
